    ...
    html:
        code-links:
            - text: Starter Files ZIP
              icon: server
              href: https://github.com/usma-eecs/cy350-project3-starter/archive/refs/heads/main.zip
            - text: Starter Files GitHub
              icon: github
              href: https://github.com/usma-eecs/cy350-project3-starter
title: Project 3 - Comprehensive Networking Project
description: Extending your web application with POST requests, Selective Repeat, dynamic routing updates, switches, and encryption.
date: 2026-04-22
